...
<div class="col-md-6 col-lg-4 mt-4" id=${id} key=${id}>
    <div class="card shadow task__card">
        ...
        <div class='card-body'>
        ${url
        ? `<img width='100%' height='150px' style="object-fit: cover; object-position: center"  src=${url} alt='card image cap' class='card-img-top md-3 rounded-lg' />`
        : `
...
const htmlModalContent = ({ id, title, description, url }) => {
    ...
    <div id = ${id}>
        ${url ?
            `<img width="100%" src="${url}" alt="image cap" class='img-img-fluid place__holder__img mb-3'/>  ` :
            `<img width="100%" src="https://reactnativecode.com/wp-content/uploads/2018/02/Default_Image_Thumbnail.png" alt="image cap" class='img-img-fluid place__holder__img mb-3'/>  `
        }
        <strong class="text-sm text-muted">Created on ${date.toLocaleDateString}</strong>
